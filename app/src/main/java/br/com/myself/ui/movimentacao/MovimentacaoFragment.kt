package br.com.myself.ui.movimentacao
...
import br.com.myself.ui.despesa.CriarDespesaDialog
import br.com.myself.ui.despesa.DespesasFragment
import br.com.myself.ui.registros.RegistrosFragment
import br.com.myself.ui.registros.CriarRegistroDialog
            ...
            when (item.itemId) {
                R.id.bottom_navigation_registros -> {
                    childFragmentManager.beginTransaction()
                        ...
                        .replace(R.id.fragment_container_movimentacao,
                            RegistrosFragment()
                        )
                        .commit()
        ...
        view.post {
            activity.toolbar.menu.findItem(R.id.action_adicionar).setOnMenuItemClickListener {
                when (bottom_navigation_view_movimentacao.selectedItemId) {
                    R.id.bottom_navigation_registros -> CriarRegistroDialog(
                        view.context
                    ).show()
                    R.id.bottom_navigation_despesas -> CriarDespesaDialog(
                        view.context
                    ).show()
                }
                true
