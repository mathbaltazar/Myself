...
class RegistrarDespesaDialog(
    context: Context, private val despesa: Despesa, private val controller: DespesasController
) : Dialog(context) {
    ...
    private fun setUpView() {
        ...
        et_dialog_registrar_despesa_novo_valor.setText(Utils.formatCurrency(despesa.valor))
        et_dialog_registrar_despesa_novo_valor.apply { addTextChangedListener(CurrencyMask(this)) }
        ...
        val chipSingleSelectionBehavior = { tag: String ->
            ...
            when (tag) {
                CHIP_OUTRA_DATA -> til_dialog_registrar_despesa_data.visibility = View.VISIBLE
                CHIP_HOJE -> {
        ...
        button_dialog_registrar_despesa_registrar.setOnClickListener {
            ...
            val valor = et_dialog_registrar_despesa_novo_valor.text.toString()
            ...
            val margem = despesa.valor - Utils.unformatCurrency(valor).toDouble()
            
            val data = et_dialog_registrar_despesa_data.text.toString().parseDate()
            
            controller.registrar(despesa, data, margem)
            cancel()
        }
    }
